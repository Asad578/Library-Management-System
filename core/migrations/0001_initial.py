# Generated by Django 6.0.1 on 2026-01-12 07:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='fine', to='core.issue')),
            ],
        ),
        migrations.CreateModel(
            name='IssueHistory',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('issued', 'Issued'), ('returned', 'Returned'), ('renewed', 'Renewed'), ('overdue', 'Overdue'), ('fine_paid', 'Fine Paid')], max_length=20)),
